"""money_x_22397 URL Configuration
...
admin.site.site_header = "Money X"
admin.site.site_title = "Money X Admin Portal"
admin.site.index_title = "Money X Admin"

# swagger
api_info = openapi.Info(
    title="Money X API",
    default_version="v1",
    description="API documentation for Money X App",
)
